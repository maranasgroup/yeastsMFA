function run_minSSR_func()
    ...
    % Save
    save(strcat(path_expmt, 'models_v73.mat'), 'model', 'mfamodel', 'emus', 'emod', '-v7.3');
    toc
    ...
    % Save
    save(strcat(path_expmt, 'res_v73.mat'), 'model', 'mfamodel', 'emus', 'emod',...
        'res', 'foptCell', 'residualCell', '-v7.3');
    toc
